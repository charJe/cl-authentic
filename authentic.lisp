...
;;;
;;; authentic.lisp --- Password management for Common Lisp (web) applications.
...
(defun open-password-database
    (&key (spec '(("password-store.sqlite3") :database-type :sqlite3 :if-exists :old)))
  "Open password database specified by :SPEC, which must be an argument list suitable for clsql:connect.
Default is to use '((\"password-store.sqlite3\") :sqlite3); if you use this default you will have to have clsql-sqlite3 loaded too.
